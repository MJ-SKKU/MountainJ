          ...
          <div className="bg-white mx-5 rounded-md pb-2">
            {myPay.map((content, idx) => (
              ...
              >
                ...
                >
                  <div style={{ border: ``,fontWeight:`bold` }}>{content[1]}</div>
                  <div style={{ fontSize: `12px`, paddingTop:`1px` }}>{payMembersDict[content[0]]}</div>
                </div>
                <div
                  className="h-full flex flex-column justify-center align-center"
                  style={{
                ...
                >
                  <div style={{ border: `` , color: `#4B8CF7`}}>+ {content[2]}원</div>
                </div>
              </div>
            ))}
            {myParticipate.map((content, idx) => (
              ...
              >
                ...
                >
                  <div style={{ border: ``, color:`#FF5146` }}>- {content[2]}원</div>
                </div>
              </div>
            ))}
            <div
              ...
              >
                ...
                >
                  <div className="pt-3" style={{ fontWeight:`bold` }}>총 정산금액</div>
                </div>
                <div
                  className="h-full flex flex-column justify-center align-center"
                  style={{
                ...
                >
                  <div className="pt-3" style={{ fontWeight:`bold` }}>{myTotal>0?"+ ":"- "}{Math.abs(myTotal)}원</div>
                </div>
              </div>
          </div>
        )}
