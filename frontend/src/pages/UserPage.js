    ...
    <Fragment>
      <main className="mt-24">
        <div className="flex items-center mb-6">
          ...
          <div className="ml-2">
            <span className="font-scoredream text-2xl font-semibold">
              {userInfo.k_name}
            </span>
            <span className="font-scoredream text-2xl font-light">님</span>
            <br />
            <span className="font-scoredream text-2xl font-light">
              안녕하세요.
            </span>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="mb-1.5">
            이미 <span className="font-semibold text-red">완료</span>된
            정산이에요!
          </div>
                    ...
                    {memberList.map((member, index) => (
                      ...
                      >
                        ...
                        {userInfo.k_name === member ? (
                          ...
                          <button className="ml-1 text-danger" index={index}>
                            x
                          </button>
                        )}
                      </span>
